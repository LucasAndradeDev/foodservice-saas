...
import { CalendarClock, ChevronLeft, Pencil, Trash2 } from 'lucide-react'
    ...
    <div>
      ...
      {windows && windows.length === 0 && (
        <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-6 text-center">
          ...
          <p className="mb-1 text-sm font-medium text-gray-700">Nenhum horário cadastrado ainda</p>
        ...
        <div className="space-y-2">
          {windows.map((availabilityWindow) => (
            <div
              ...
              className="flex items-center justify-between gap-2 rounded-xl border border-gray-200 bg-white p-4 shadow-sm"
            >
              <div>
                <span className="font-medium text-gray-800">{dayLabel(availabilityWindow.dayOfWeek)}</span>
      ...
      {isFormOpen && (
        <Modal title={editingWindow ? 'Editar horário' : 'Novo horário de disponibilidade'} onClose={closeForm}>
          <form onSubmit={handleSubmit}>
            <label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="dayOfWeek">
              Dia da semana
            </label>
            <select
              id="dayOfWeek"
            ...
            <div className="mb-4 flex gap-3">
              <div className="flex-1">
                <label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="startTime">
                  Início
                </label>
                <input
                  id="startTime"
              ...
              <div className="flex-1">
                <label className="mb-1 block text-sm font-medium text-gray-700" htmlFor="endTime">
                  Fim
                </label>
                <input
                  id="endTime"
