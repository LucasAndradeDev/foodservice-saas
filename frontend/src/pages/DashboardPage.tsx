  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <StatTile icon={CheckCircle2} label="Mesas livres" value={data.freeTables} accentClassName="text-green-700" />
        <StatTile icon={Flame} label="Mesas ocupadas" value={data.occupiedTables} accentClassName="text-red-700" />
        <StatTile
