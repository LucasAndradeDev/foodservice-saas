  ...
  return (
    <div>
      <div className="mb-6 rounded-xl border border-gray-200 bg-white p-4 shadow-xs dark:border-white/10 dark:bg-stone-900">
        ...
        <div className="flex w-fit items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 transition-colors focus-within:border-brand-500 focus-within:bg-white dark:border-white/10 dark:bg-white/5 dark:focus-within:bg-stone-900">
          <input
            ...
            className="bg-transparent text-sm text-gray-700 focus:outline-none dark:text-stone-300"
          />
      ...
      {summary && summary.totalCount > 0 && (
        <div className="mb-6 flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-stone-900">
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-stone-900">
        {isLoading || !entriesPage ? (
          <p className="px-4 py-3 text-sm text-gray-500 dark:text-stone-400">Carregando...</p>
          ...
          <>
            ...
            <div className="flex items-center justify-between border-t border-gray-100 px-4 py-3 dark:border-white/10">
              <button
                ...
                className="flex items-center gap-1 rounded-md border border-gray-200 px-3 py-1.5 text-sm text-gray-600 hover:bg-gray-50 disabled:opacity-40 dark:border-white/10 dark:text-stone-400 dark:hover:bg-white/5"
              >
